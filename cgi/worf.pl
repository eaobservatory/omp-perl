...
sub print_JAC_header {
  print <<END;
<head>
  <title>WORF: UKIRT eavesdropping</title>
</head>
<body bgcolor="#bbbbcc" text="#000000" link="#cc0000" vlink="#aa0000" alink="#ff0000">
  <div align="center"><a href="http://www.jach.hawaii.edu/JAClocal/cgi-bin/worf.pl">WORF main page</a></div>
  <hr>
END
};
