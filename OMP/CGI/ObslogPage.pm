package OMP::CGI::ObslogPage;

=head1 NAME

OMP::CGI::ObslogPage - Disply complete observation log web pages
...
#  print "<p><a href=\"fbworfthumb.pl?ut=$utdate&telescope=$telescope\">View WORF thumbnails</a>\n";
  ...
  my $plot_html = OMP::CGI::Weather::tau_plot_code($utdate);
  ...
  OMP::CGI::MSB::msb_comments($q, $observed, $sp);
  ...
  print "<p>";
  # Display WVM graph
  my $wvm_html = OMP::CGI::Weather::wvm_graph_code($utdate);
  print $wvm_html;
}
...
C<OMP::CGI::Obslog>, C<OMP::CGI::MSB>, C<OMP::CGI::Shiftlog>, C<OMP::CGI::Weather>
