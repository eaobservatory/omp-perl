package OMP::CGI::ObsReportPage;

=head1 NAME

OMP::CGI::ObsReportPage - Web display of observing reports

=head1 SYNOPSIS

  use OMP::CGI::ObsReportPage;
...
#    my $url = OMP::Config->getData('omp-private') . OMP::Config->getData('cgidir') . "/nightrep.pl";
    ...
    if (! $utdate_end) {
      $wvm_html = OMP::CGI::Weather::wvm_graph_code($utdate->ymd);
      print $wvm_html;
    }
  }
}
