package OMP::WORF::JCMT_GSD;

=head1 NAME

OMP::WORF::JCMT_GSD - Specific functions for WORF for GSD files
taken at JCMT.
...
use OMP::WORF::JCMT_GSD;

  my $worf = new OMP::WORF::JCMT_GSD( obs => $obs, suffix => $suffix );
