package OMP::WORF::RXA3I;

=head1 NAME

OMP::WORF::RXA3I - RXA3I-specific functions for WORF
...
use OMP::WORF::RXA3I;
  ...
  my $worf = new OMP::WORF::RXA3I( obs => $obs, suffix => $suffix );
...
This subclass of C<OMP::WORF> supplies RXA3I-specific functions
for WORF. In particular, it allows for plotting of images and retrieving
a list of valid suffices for RXA3I data.
