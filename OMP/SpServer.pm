...
sub storeProgram {
  ...
  try {
    ...
    if (!defined $otver || $otver < $minver) {
      ...
      throw OMP::Error::StoreFail("This science program was generated by a version of the OT (ver. $otver) that is too old for submitting programmes for this semester. Please upgrade to at least version $minver, available from http://www.jach.hawaii.edu/JAC/software/jcmtot/download.html");
    }
